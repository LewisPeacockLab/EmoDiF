...
% permuted for 3 axis. The third output, flip (1x3 logical), indicates an
% original axis is flipped if true.
a = abs(R(1:3,1:3));
[~, ixyz] = max(a);
...
% optional output is the form code of the returned matrix.
