function [rsa] = emodif_rsa_aggP_DF_hyper(subjNum,maskName, shift, dfencodeTRstart, dfencodeTRlength)
...
%   args.preview_dir = sprintf('%s/results/%s/%s',args.subj_dir, args.train_phase, train_date);
  args.output_dir = sprintf('%s/results/rsa_results/preview_dfencode/scene_200/%d',args.subj_dir,args.previewshiftTR);
...
mvpa_mask = 'scene_200.nii';

%grab data from .csv files. 
%group2 
if subjNum == 105 || subjNum == 106 || subjNum == 107 || subjNum == 108
    preview_data = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group2-Preview.csv');
    preview_labels = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group2-Preview-subjlabels.csv');
    DF_labels = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group2-DF_encoding-subjlabels.csv');
    DF_data = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group2-DF_encoding.csv');
    
elseif subjNum == 109 || subjNum == 110 || subjNum == 111 || subjNum == 125
    preview_data = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group3-Preview.csv');
    preview_labels = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group3-Preview-subjlabels.csv');
    DF_labels= load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group3-DF_encoding-subjlabels.csv');
    DF_data = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group3-DF_encoding.csv');
    
elseif subjNum == 113|| subjNum == 114|| subjNum == 115 || subjNum == 116
    preview_data = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group4-Preview.csv');
    preview_labels = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group4-Preview-subjlabels.csv');
    DF_labels = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group4-DF_encoding-subjlabels.csv');
    DF_data = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group4-DF_encoding.csv');
    
elseif subjNum == 117|| subjNum == 118|| subjNum == 119 || subjNum == 120
    preview_data = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group5-Preview.csv');
    preview_labels = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group5-Preview-subjlabels.csv');
    DF_labels= load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group5-DF_encoding-subjlabels.csv');
    DF_data = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group5-DF_encoding.csv');
elseif subjNum == 121|| subjNum == 122|| subjNum == 123 || subjNum == 124
    preview_data = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group6-Preview.csv');
    preview_labels = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group6-Preview-subjlabels.csv');
    DF_labels= load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group6-DF_encoding-subjlabels.csv');
    DF_data = load('/Users/tw24955/emodif_data/aggregate_results/RSA_results/scene_200/commonspace-group6-DF_encoding.csv');
end


rsa.preview.raw_data = horzcat(preview_labels, preview_data)';
rsa.DFencode.raw_data = horzcat(DF_labels, DF_data)';

my_DF_data_col = find(subjNum == DF_labels)';
my_DF_data = rsa.DFencode.raw_data((2:end),my_DF_data_col(1):my_DF_data_col(end));

my_preview_data_col = find(subjNum == preview_labels)';
my_preview_data = rsa.preview.raw_data((2:end),my_preview_data_col(1):my_preview_data_col(end));

%for group preview data
rsa.preview.raw_data1 = rsa.preview.raw_data((2:end),1:366);
rsa.preview.raw_data2 = rsa.preview.raw_data((2:end),367:732);
rsa.preview.raw_data3 = rsa.preview.raw_data((2:end),733:1098);
rsa.preview.raw_data4 = rsa.preview.raw_data((2:end), 1099:end);
rsa.preview.raw_data_stacked = cat(3,rsa.preview.raw_data1,rsa.preview.raw_data2,rsa.preview.raw_data3,rsa.preview.raw_data4);
rsa.preview.raw_data_mean = mean(rsa.preview.raw_data_stacked,3); %this is the new pattern to correlate to
...
%DFencoding phase
    ...
    for m = 1:args.trialnum
        ...
        trial_patt_mean = mean(my_DF_data(:,trialTR_mean(1):(trialTR_mean(args.DFencode.meanTR_length))),2);
        trial_patt_1 = my_DF_data(:,trialTR_mean(1));
        trial_patt_2 = my_DF_data(:,trialTR_mean(2));
        trial_patt_3 = my_DF_data(:,trialTR_mean(3));
        
       rsa.DFencode.patterns.mean(:,m)  = trial_patt_mean;
       rsa.DFencode.patterns.patt1(:,m) = trial_patt_1;
       rsa.DFencode.patterns.patt2(:,m) = trial_patt_2;
       rsa.DFencode.patterns.patt3(:,m) = trial_patt_3;
    end
...
%         rsa.DFencode.mean.patterns(:,m) = trial_patt;
            ...
            P_trial_patt_mean_match= mean(my_preview_data(:,P_trialTR_idx_TRsOI(1):(P_trialTR_idx_TRsOI(args.preview.meanTR_length))),2);
            trial_patt_1 = my_preview_data(:, P_trialTR_idx_TRsOI(1));
            trial_patt_2 = my_preview_data(:, P_trialTR_idx_TRsOI(2));
            trial_patt_3 = my_preview_data(:, P_trialTR_idx_TRsOI(3));
            
            rsa.preview.patterns.mean(:,rsa.preview.preview2DFencode_nonexpanded(m)) = P_trial_patt_mean_match;
            rsa.preview.patterns.patt1(:,rsa.preview.preview2DFencode_nonexpanded(m)) = trial_patt_1;
            rsa.preview.patterns.patt2(:,rsa.preview.preview2DFencode_nonexpanded(m)) = trial_patt_2;
            rsa.preview.patterns.patt3(:,rsa.preview.preview2DFencode_nonexpanded(m)) = trial_patt_3;
            
            
    end
    
% R and F
rsa.DFencode.patterns.Rmean = [];
rsa.DFencode.patterns.Fmean = [];
rsa.preview.patterns.Rmean = [];
rsa.preview.patterns.Fmean = [];
...
for k = 1:args.trialnum
    ...
    if rsa.DFencode.instr(DF_trialTR_idx(dfencodeTRstart)) == 0 %if the 1st TR shows that it's Forget
        ...
        DF_trial_patt_Fmean = mean(my_DF_data(:,(DF_trialTR_Fidx_TRsOI(1)):DF_trialTR_Fidx_TRsOI(args.DFencode.meanTR_length)),2);
        rsa.DFencode.patterns.Fmean = horzcat(rsa.DFencode.patterns.Fmean, DF_trial_patt_Fmean);
        
        %we haven't done the 1,2,3 - trials, but mean for the R and F. 
        
        %now for preview trials
        rsa.preview.patterns.Fmean= horzcat(rsa.preview.patterns.Fmean,rsa.preview.patterns.mean(:,k)); %taking the pattern from the preview matched matrix
    ...
    elseif rsa.DFencode.instr(DF_trialTR_idx(dfencodeTRstart)) == 1
        ...
        DF_trial_patt_Rmean = mean(my_DF_data(:,(DF_trialTR_Ridx_TRsOI(1)):DF_trialTR_Ridx_TRsOI(args.DFencode.meanTR_length)),2);
        
        rsa.DFencode.patterns.Rmean = horzcat(rsa.DFencode.patterns.Rmean, DF_trial_patt_Rmean);
        %now for preview trials
        rsa.preview.patterns.Rmean = horzcat(rsa.preview.patterns.Rmean,rsa.preview.patterns.mean(:,k)); %taking the pattern from the preview matched matrix
    ...
    %1st
        ...
        corr_matrix_match_first = zeros(args.trialnum,args.trialnum);
    corr_matrix_match_firstz= zeros(args.trialnum,args.trialnum);
    
    for x = 1:args.trialnum %trial number
        
        for y = 1:args.trialnum %trial number
            
            corr_matrix_match_first(x, y) = corr2(rsa.DFencode.patterns.patt1(:,x), rsa.preview.patterns.patt1(:,y));
            corr_matrix_match_firstz(x, y) = 0.5*log((1+corr_matrix_match_first(x, y))/(1-corr_matrix_match_first(x, y)));
            rsa.results.smatrix.corr_matrix_match_first = corr_matrix_match_first;
            rsa.results.smatrix.corr_matrix_match_firstz = corr_matrix_match_firstz;
        end
    end
    ...
    %2nd
            ...
            corr_matrix_match_second = zeros(args.trialnum,args.trialnum);
    corr_matrix_match_secondz= zeros(args.trialnum,args.trialnum);
    
    for x = 1:args.trialnum %trial number
        
        for y = 1:args.trialnum %trial number
            
            corr_matrix_match_second(x, y) = corr2(rsa.DFencode.patterns.patt2(:,x), rsa.preview.patterns.patt2(:,y));
            corr_matrix_match_secondz(x, y) = 0.5*log((1+corr_matrix_match_second(x, y))/(1-corr_matrix_match_second(x, y)));
            rsa.results.smatrix.corr_matrix_match_second = corr_matrix_match_second;
            rsa.results.smatrix.corr_matrix_match_secondz = corr_matrix_match_secondz;
        end
    end
    
    %3rd
    
                corr_matrix_match_third = zeros(args.trialnum,args.trialnum);
    corr_matrix_match_thirdz= zeros(args.trialnum,args.trialnum);
    
    for x = 1:args.trialnum %trial number
        
        for y = 1:args.trialnum %trial number
            
            corr_matrix_match_third(x, y) = corr2(rsa.DFencode.patterns.patt3(:,x), rsa.preview.patterns.patt3(:,y));
            corr_matrix_match_thirdz(x, y) = 0.5*log((1+corr_matrix_match_third(x, y))/(1-corr_matrix_match_third(x, y)));
            rsa.results.smatrix.corr_matrix_match_third = corr_matrix_match_third;
            rsa.results.smatrix.corr_matrix_match_thirdz = corr_matrix_match_thirdz;
        end
    end
    ...
    for x = 1:args.trialnum %trial number
        ...
        for y = 1:args.trialnum %trial number
            ...
            corr_matrix_match_full(x, y) = corr2(rsa.DFencode.patterns.mean(:,x), rsa.preview.patterns.mean(:,y));
    ...
    for x = 1:args.trialnum/2 %trial number
        ...
        for y = 1:args.trialnum/2 %trial number
            ...
            corr_matrix_match_F(x, y) = corr2(rsa.DFencode.patterns.Fmean(:,x), rsa.preview.patterns.Fmean(:,y));
    ...
    for x = 1:args.trialnum/2 %trial number
        ...
        for y = 1:args.trialnum/2 %trial number
            ...
            corr_matrix_match_R(x, y) = corr2(rsa.DFencode.patterns.Rmean(:,x), rsa.preview.patterns.Rmean(:,y));
...
%     
%         second_fig = figure;
%     set(second_fig, 'Position', [0 0 1500 1500])
%     
%     subplot(1,1,1)
%     imagesc(corr_matrix_match_second); colormap('parula'); colorbar; 
%     args.confplot.origcoloraxis = caxis;
%     
%     if strcmp(maskName,'JC_Combine_PHc_epi_space') == 1
%         caxis([-.25 .25]);
...
%     ylabel(sprintf('Preview raw patterns averaged over TR %d: TR %d run 1',args.DFencode.meanTR_start,args.DFencode.meanTR_end),'FontSize',15,'FontWeight','bold');
%     xlabel(sprintf('DFencode raw patterns averaged over TR %d: TR %d run 1',args.preview.meanTR_start, args.preview.meanTR_end),'FontSize',15,'FontWeight','bold');
%     saveas(second_fig, sprintf('emodif%s_run_second_TRstart%d_mean%d',subjNum,args.DFencode.meanTR_start,args.DFencode.meanTR_length),'png')
...
%     
    ...
    rsa.parameters = args;
    results_file = sprintf('%s/%s_TR%dto%d_aggP_DF_rsa_hyper_results.mat',...
