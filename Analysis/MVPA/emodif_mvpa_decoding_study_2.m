...
function emodif_mvpa_decoding_study_2(subjNum,maskName,classifier,categories,penalty,shiftTRs,test_phase,rest_shift)
  
  %----------------------------------------------------------------------
  % [stuff] = emodif_mvpa_training_localizer(... ALL ARGS ARE STRINGS ...)
  % * for development -
  % emodif_mvpa_decoding_study_2('104','tempoccfusi_pHg_LOC_combined_epi_space','L2logreg','fsowr', '50','02', 'DFencode', 2)
