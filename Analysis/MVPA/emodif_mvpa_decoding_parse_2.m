function emodif_mvpa_decoding_parse_2(subjNum,maskName,conditions,test_phase, test_date);
%*emodif_mvpa_decoding_parse_2('104','tempoccfusi_pHg_LOC_combined_epi_space','fsoner', 'DFencode','13-Jun-2018')
