...
if strcmp(test_phase, 'DFencode') == true
    ...
    results_rem_precue_acts_word = nanmean(results.remember.all.acts.word(:,1:3),2); %merging 1-3TR
    results.remember.all.bar.precue.word.bytrial = results_rem_precue_acts_word;
    results.remember.all.bar.precue.word.nanmean = nanmean(results.remember.all.bar.precue.word.bytrial);
    results.remember.all.bar.precue.word.std = std(results.remember.all.bar.precue.word.bytrial);
    ...
    results.remember.all.bar.precue.word_facenorm.bytrial = results.remember.all.bar.precue.word.bytrial-results.remember.all.bar.precue.face.bytrial;
    results.remember.all.bar.precue.word_facenorm.nanmean = nanmean(results.remember.all.bar.precue.word_facenorm.bytrial);
    results.remember.all.bar.precue.word_facenorm.std = std(results.remember.all.bar.precue.word_facenorm.bytrial);
    ...
    results_rem_postcue_acts_word = nanmean(results.remember.all.acts.word(:,5:7),2); %merging 1-3TR
    results.remember.all.bar.postcue.word.bytrial = results_rem_postcue_acts_word;
    results.remember.all.bar.postcue.word.nanmean = nanmean(results.remember.all.bar.postcue.word.bytrial );
    results.remember.all.bar.postcue.word.std = std(results.remember.all.bar.postcue.word.bytrial );
    ...
    results.remember.all.bar.postcue.word_facenorm.bytrial = results.remember.all.bar.postcue.word.bytrial-results.remember.all.bar.postcue.face.bytrial;
    ...
    results_for_precue_acts_word = nanmean(results.forget.all.acts.word(:,1:3),2); %merging 1-3TR
    results.forget.all.bar.precue.word.bytrial = results_for_precue_acts_word;
    results.forget.all.bar.precue.word.nanmean = nanmean(results.forget.all.bar.precue.word.bytrial);
    results.forget.all.bar.precue.word.std = std(results.forget.all.bar.precue.word.bytrial);
    ...
    results.forget.all.bar.precue.word_facenorm.bytrial = results.forget.all.bar.precue.word.bytrial-results.forget.all.bar.precue.face.bytrial;
    results.forget.all.bar.precue.word_facenorm.nanmean = nanmean(results.forget.all.bar.precue.word_facenorm.bytrial);
    results.forget.all.bar.precue.word_facenorm.std = std(results.forget.all.bar.precue.word_facenorm.bytrial);
    ...
    results_for_postcue_acts_word = nanmean(results.forget.all.acts.word(:,5:7),2); %merging 1-3TR
    results.forget.all.bar.postcue.word.bytrial = results_for_postcue_acts_word;
    results.forget.all.bar.postcue.word.nanmean = nanmean(results.forget.all.bar.postcue.word.bytrial);
    results.forget.all.bar.postcue.word.std = std(results.forget.all.bar.postcue.word.nanmean);
    ...
    results.forget.all.bar.postcue.word_facenorm.bytrial = results.forget.all.bar.postcue.word.bytrial-results.forget.all.bar.postcue.face.bytrial;
    ...
    results_rem_merged_old_precue_acts_word = nanmean(results.remember.merged.acts.OLD.word(:,1:3),2); %merging 1-3TR
    results.remember.merged.bar.OLD.precue.word.bytrial =  results_rem_merged_old_precue_acts_word;
    results.remember.merged.bar.OLD.precue.word.nanmean = nanmean(results.remember.merged.bar.OLD.precue.word.bytrial);
    results.remember.merged.bar.OLD.precue.word.std = std(results.remember.merged.bar.OLD.precue.word.bytrial);
  ...
  %Remember - MERGED - OLD - POSTCUE
    ...
    results_rem_merged_old_postcue_acts_word = nanmean(results.remember.merged.acts.OLD.word(:,5:7),2); %merging 1-3TR
    results.remember.merged.bar.OLD.postcue.word.bytrial =  results_rem_merged_old_postcue_acts_word;
    results.remember.merged.bar.OLD.postcue.word.nanmean = nanmean(results.remember.merged.bar.OLD.postcue.word.bytrial);
    results.remember.merged.bar.OLD.postcue.word.std = std(results.remember.merged.bar.OLD.postcue.word.bytrial);
    ...
    if subjNum == '103' | subjNum == '113' | subjNum == '115' | subjNum == '114' | subjNum == '119';% has 0 here 
        ...
        results.remember.merged.bar.NEW.precue.word.bytrial =  NaN;
        results.remember.merged.bar.NEW.precue.word.nanmean = NaN;
        results.remember.merged.bar.NEW.precue.word.std = NaN;
        ...
        results.remember.merged.bar.NEW.postcue.word.bytrial =  NaN;
        results.remember.merged.bar.NEW.postcue.word.nanmean = NaN;
        results.remember.merged.bar.NEW.postcue.word.std = NaN;
        ...
        results_rem_merged_new_precue_acts_word = nanmean(results.remember.merged.acts.NEW.word(:,1:3),2); %merging 1-3TR
        results.remember.merged.bar.NEW.precue.word.bytrial =  results_rem_merged_new_precue_acts_word;
        results.remember.merged.bar.NEW.precue.word.nanmean = nanmean(results.remember.merged.bar.NEW.precue.word.bytrial);
        results.remember.merged.bar.NEW.precue.word.std = std(results.remember.merged.bar.NEW.precue.word.bytrial);
        ...
        results_rem_merged_new_postcue_acts_word = nanmean(results.remember.merged.acts.NEW.word(:,5:7),2); %merging 1-3TR
        results.remember.merged.bar.NEW.postcue.word.bytrial =  results_rem_merged_new_postcue_acts_word;
        results.remember.merged.bar.NEW.postcue.word.nanmean = nanmean(results.remember.merged.bar.NEW.postcue.word.bytrial);
        results.remember.merged.bar.NEW.postcue.word.std = std(results.remember.merged.bar.NEW.postcue.word.bytrial);
    ...
    results_rem_highconf_old_precue_acts_word = nanmean(results.remember.highconf.acts.OLD.word(:,1:3),2); %merging 1-3TR
    results.remember.highconf.bar.OLD.precue.word.bytrial =  results_rem_highconf_old_precue_acts_word;
    results.remember.highconf.bar.OLD.precue.word.nanmean = nanmean(results.remember.highconf.bar.OLD.precue.word.bytrial);
    results.remember.highconf.bar.OLD.precue.word.std = std(results.remember.highconf.bar.OLD.precue.word.bytrial);
  ...
  results_rem_highconf_old_postcue_acts_word = nanmean(results.remember.highconf.acts.OLD.word(:,5:7),2); %merging 1-3TR
  results.remember.highconf.bar.OLD.postcue.word.bytrial =  results_rem_highconf_old_postcue_acts_word;
  results.remember.highconf.bar.OLD.postcue.word.nanmean = nanmean(results.remember.highconf.bar.OLD.postcue.word.bytrial);
  results.remember.highconf.bar.OLD.postcue.word.std = std(results.remember.highconf.bar.OLD.postcue.word.bytrial);
  ...
  if subjNum == '103' | subjNum == '113'
      ...
      results.remember.highconf.bar.NEW.precue.word.bytrial =  NaN;
      results.remember.highconf.bar.NEW.precue.word.nanmean = NaN;
      results.remember.highconf.bar.NEW.precue.word.std = NaN;
      ...
      results.remember.highconf.bar.NEW.postcue.word.bytrial =  NaN;
      results.remember.highconf.bar.NEW.postcue.word.nanmean = NaN;
      results.remember.highconf.bar.NEW.postcue.word.std = NaN;
      ...
      results_rem_highconf_new_precue_acts_word = nanmean(results.remember.highconf.acts.NEW.word(:,1:3),2); %merging 1-3TR
      results.remember.highconf.bar.NEW.precue.word.bytrial =  results_rem_highconf_new_precue_acts_word;
      results.remember.highconf.bar.NEW.precue.word.nanmean = nanmean(results.remember.highconf.bar.NEW.precue.word.bytrial);
      results.remember.highconf.bar.NEW.precue.word.std = std(results.remember.highconf.bar.NEW.precue.word.bytrial);
      ...
      results_rem_highconf_new_postcue_acts_word = nanmean(results.remember.highconf.acts.NEW.word(:,5:7),2); %merging 1-3TR
      results.remember.highconf.bar.NEW.postcue.word.bytrial =  results_rem_highconf_new_postcue_acts_word;
      results.remember.highconf.bar.NEW.postcue.word.nanmean = nanmean(results.remember.highconf.bar.NEW.postcue.word.bytrial);
      results.remember.highconf.bar.NEW.postcue.word.std = std(results.remember.highconf.bar.NEW.postcue.word.bytrial);
    ...
    results_for_merged_old_precue_acts_word = nanmean(results.forget.merged.acts.OLD.word(:,1:3),2); %merging 1-3TR
    results.forget.merged.bar.OLD.precue.word.bytrial =  results_for_merged_old_precue_acts_word;
    results.forget.merged.bar.OLD.precue.word.nanmean = nanmean(results.forget.merged.bar.OLD.precue.word.bytrial);
    results.forget.merged.bar.OLD.precue.word.std = std(results.forget.merged.bar.OLD.precue.word.bytrial);
  ...
  %forget - MERGED - OLD - POSTCUE
    ...
    results_for_merged_old_postcue_acts_word = nanmean(results.forget.merged.acts.OLD.word(:,5:7),2); %merging 1-3TR
    results.forget.merged.bar.OLD.postcue.word.bytrial =  results_for_merged_old_postcue_acts_word;
    results.forget.merged.bar.OLD.postcue.word.nanmean = nanmean(results.forget.merged.bar.OLD.postcue.word.bytrial);
    results.forget.merged.bar.OLD.postcue.word.std = std(results.forget.merged.bar.OLD.postcue.word.bytrial);
  ...
  %forget - MERGED - NEW- POSTCUE
    ...
    results_for_merged_new_precue_acts_word = nanmean(results.forget.merged.acts.NEW.word(:,1:3),2); %merging 1-3TR
    results.forget.merged.bar.NEW.precue.word.bytrial =  results_for_merged_new_precue_acts_word;
    results.forget.merged.bar.NEW.precue.word.nanmean = nanmean(results.forget.merged.bar.NEW.precue.word.bytrial);
    results.forget.merged.bar.NEW.precue.word.std = std(results.forget.merged.bar.NEW.precue.word.bytrial);
  ...
  %forget - MERGED - NEW- POSTCUE
    ...
    results_for_merged_new_postcue_acts_word = nanmean(results.forget.merged.acts.NEW.word(:,5:7),2); %merging 1-3TR
    results.forget.merged.bar.NEW.postcue.word.bytrial =  results_for_merged_new_postcue_acts_word;
    results.forget.merged.bar.NEW.postcue.word.nanmean = nanmean(results.forget.merged.bar.NEW.postcue.word.bytrial);
    results.forget.merged.bar.NEW.postcue.word.std = std(results.forget.merged.bar.NEW.postcue.word.bytrial);
    ...
    results_for_highconf_old_precue_acts_word = nanmean(results.forget.highconf.acts.OLD.word(:,1:3),2); %merging 1-3TR
    results.forget.highconf.bar.OLD.precue.word.bytrial =  results_for_highconf_old_precue_acts_word;
    results.forget.highconf.bar.OLD.precue.word.nanmean = nanmean(results.forget.highconf.bar.OLD.precue.word.bytrial);
    results.forget.highconf.bar.OLD.precue.word.std = std(results.forget.highconf.bar.OLD.precue.word.bytrial);
  ...
  %forget - highconf - OLD - POSTCUE
    ...
    results_for_highconf_old_postcue_acts_word = nanmean(results.forget.highconf.acts.OLD.word(:,5:7),2); %merging 1-3TR
    results.forget.highconf.bar.OLD.postcue.word.bytrial =  results_for_highconf_old_postcue_acts_word;
    results.forget.highconf.bar.OLD.postcue.word.nanmean = nanmean(results.forget.highconf.bar.OLD.postcue.word.bytrial);
    results.forget.highconf.bar.OLD.postcue.word.std = std(results.forget.highconf.bar.OLD.postcue.word.bytrial);
  ...
  %forget - highconf - NEW- POSTCUE
    ...
    results_for_highconf_new_precue_acts_word = nanmean(results.forget.highconf.acts.NEW.word(:,1:3),2); %merging 1-3TR
    results.forget.highconf.bar.NEW.precue.word.bytrial =  results_for_highconf_new_precue_acts_word;
    results.forget.highconf.bar.NEW.precue.word.nanmean = nanmean(results.forget.highconf.bar.NEW.precue.word.bytrial);
    results.forget.highconf.bar.NEW.precue.word.std = std(results.forget.highconf.bar.NEW.precue.word.bytrial);
  ...
  %forget - highconf - NEW- POSTCUE
    ...
    results_for_highconf_new_postcue_acts_word = nanmean(results.forget.highconf.acts.NEW.word(:,5:7),2); %merging 1-3TR
    results.forget.highconf.bar.NEW.postcue.word.bytrial =  results_for_highconf_new_postcue_acts_word;
    results.forget.highconf.bar.NEW.postcue.word.nanmean = nanmean(results.forget.highconf.bar.NEW.postcue.word.bytrial);
    results.forget.highconf.bar.NEW.postcue.word.std = std(results.forget.highconf.bar.NEW.postcue.word.bytrial);
    ...
    results_rem_neu_precue_acts_word = nanmean(results.remember.neu.acts.word(:,1:3),2); %merging 1-3TR
    results.remember.neu.bar.precue.word.bytrial =  results_rem_neu_precue_acts_word;
    results.remember.neu.bar.precue.word.nanmean = nanmean(results.remember.neu.bar.precue.word.bytrial);
    results.remember.neu.bar.precue.word.std = std(results.remember.neu.bar.precue.word.bytrial);
    ...
    results_rem_neu_postcue_acts_word = nanmean(results.remember.neu.acts.word(:,5:7),2); %merging 1-3TR
    results.remember.neu.bar.postcue.word.bytrial =  results_rem_neu_postcue_acts_word;
    results.remember.neu.bar.postcue.word.nanmean = nanmean(results.remember.neu.bar.postcue.word.bytrial);
    results.remember.neu.bar.postcue.word.std = std(results.remember.neu.bar.postcue.word.bytrial);
    ...
    results_rem_neg_precue_acts_word = nanmean(results.remember.neg.acts.word(:,1:3),2); %merging 1-3TR
    results.remember.neg.bar.precue.word.bytrial =  results_rem_neg_precue_acts_word;
    results.remember.neg.bar.precue.word.nanmean = nanmean(results.remember.neg.bar.precue.word.bytrial);
    results.remember.neg.bar.precue.word.std = std(results.remember.neg.bar.precue.word.bytrial);
    ...
    results_rem_neg_postcue_acts_word = nanmean(results.remember.neg.acts.word(:,5:7),2); %merging 1-3TR
    results.remember.neg.bar.postcue.word.bytrial =  results_rem_neg_postcue_acts_word;
    results.remember.neg.bar.postcue.word.nanmean = nanmean(results.remember.neg.bar.postcue.word.bytrial);
    results.remember.neg.bar.postcue.word.std = std(results.remember.neg.bar.postcue.word.bytrial);
    ...
    results_for_neu_precue_acts_word = nanmean(results.forget.neu.acts.word(:,1:3),2); %merging 1-3TR
    results.forget.neu.bar.precue.word.bytrial =  results_for_neu_precue_acts_word;
    results.forget.neu.bar.precue.word.nanmean = nanmean(results.forget.neu.bar.precue.word.bytrial);
    results.forget.neu.bar.precue.word.std = std(results.forget.neu.bar.precue.word.bytrial);
    ...
    results_for_neu_postcue_acts_word = nanmean(results.forget.neu.acts.word(:,5:7),2); %merging 1-3TR
    results.forget.neu.bar.postcue.word.bytrial =  results_for_neu_postcue_acts_word;
    results.forget.neu.bar.postcue.word.nanmean = nanmean(results.forget.neu.bar.postcue.word.bytrial);
    results.forget.neu.bar.postcue.word.std = std(results.forget.neu.bar.postcue.word.bytrial);
    ...
    results_for_neg_precue_acts_word = nanmean(results.forget.neg.acts.word(:,1:3),2); %merging 1-3TR
    results.forget.neg.bar.precue.word.bytrial =  results_for_neg_precue_acts_word;
    results.forget.neg.bar.precue.word.nanmean = nanmean(results.forget.neg.bar.precue.word.bytrial);
    results.forget.neg.bar.precue.word.std = std(results.forget.neg.bar.precue.word.bytrial);
    ...
    results_for_neg_postcue_acts_word = nanmean(results.forget.neg.acts.word(:,5:7),2); %merging 1-3TR
    results.forget.neg.bar.postcue.word.bytrial =  results_for_neg_postcue_acts_word;
    results.forget.neg.bar.postcue.word.nanmean = nanmean(results.forget.neg.bar.postcue.word.bytrial);
    results.forget.neg.bar.postcue.word.std = std(results.forget.neg.bar.postcue.word.bytrial);
