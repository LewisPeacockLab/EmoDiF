function [pcit_data ] = emodif_prepare_pcit_data_postonly(data_folders,mask)
% e.g.  emodif_prepare_pcit_data_postonly('subj_folders_011419', 'tempoccfusi_pHg_LOC_combined_epi_space')
...
for t = 1:30
    ...
    PCIT_rem_face_s(1,4) = face_rem_post(t); % net pre
...
for t = 1:30
    ...
    PCIT_rem_scene_s(1,4) = scene_rem_post(t); % net pre
...
for t = 1:30
    ...
    PCIT_rem_object_s(1,4) = object_rem_post(t); % net pre
...
for t = 1:30
    ...
    PCIT_rem_word_s(1,4) = word_rem_post(t); % net pre
...
for t = 1:30
    ...
    PCIT_rem_rest_s(1,4) = rest_rem_post(t); % net pre
...
for t = 1:30
    ...
    PCIT_for_face_s(1,4) = face_for_post(t); % net pre
...
for t = 1:30
    ...
    PCIT_for_scene_s(1,4) = scene_for_post(t); % net pre
...
for t = 1:30
    ...
    PCIT_for_object_s(1,4) = object_for_post(t); % net pre
...
for t = 1:30
    ...
    PCIT_for_word_s(1,4) = word_for_post(t); % net pre
...
for t = 1:30
    ...
    PCIT_for_rest_s(1,4) = rest_for_post(t); % net pre
...
outfilename_rem_face = 'emodif_PCIT_face_remember_post_3TRs.mat';
data = PCIT_rem_face;
save(outfilename_rem_face, 'data');

outfilename_rem_scene = 'emodif_PCIT_scene_remember_post_3TRs.mat';
data = PCIT_rem_scene;
save(outfilename_rem_scene, 'data');

outfilename_rem_object = 'emodif_PCIT_object_remember_post_3TRs.mat';
data = PCIT_rem_object;
save(outfilename_rem_object, 'data');

outfilename_rem_word  = 'emodif_PCIT_word_remember_post_3TRs.mat';
data = PCIT_rem_word;
save(outfilename_rem_word, 'data');

outfilename_rem_rest  = 'emodif_PCIT_rest_remember_post_3TRs.mat';
data = PCIT_rem_rest;
save(outfilename_rem_rest, 'data');

outfilename_for_face = 'emodif_PCIT_face_forget_post_3TRs.mat';
data = PCIT_for_face;
save(outfilename_for_face, 'data');

outfilename_for_scene = 'emodif_PCIT_scene_forget_post_3TRs.mat';
data = PCIT_for_scene;
save(outfilename_for_scene, 'data');

outfilename_for_object = 'emodif_PCIT_object_forget_post_3TRs.mat';
data = PCIT_for_object;
save(outfilename_for_object, 'data');

outfilename_for_word  = 'emodif_PCIT_word_forget_post_3TRs.mat';
data = PCIT_for_word;
save(outfilename_for_word, 'data');

outfilename_for_rest  = 'emodif_PCIT_rest_forget_post_3TRs.mat';
data = PCIT_for_rest;
