function emodif_mvpa_decoding_parse_2_behadd(subjNum, test_phase, maskName, test_date)
%*emodif_mvpa_decoding_parse_2_behadd('115','DFencode', 'tempoccfusi_pHg_LOC_combined_epi_space', '25-Sep-2018')
